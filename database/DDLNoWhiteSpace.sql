...
-- -----------------------------------------------------
-- Table `cs340_gottlija`.`F1_Seasons`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `cs340_gottlija`.`F1_Seasons` (
...
CREATE TABLE IF NOT EXISTS `cs340_gottlija`.`Grand_Prix` (
  ...
  PRIMARY KEY (`race_id`, `F1_Seasons_season_id`),
  UNIQUE INDEX `race_id_UNIQUE` (`race_id` ASC),
  INDEX `fk_Grand_Prix_F1_Seasons1_idx` (`F1_Seasons_season_id` ASC),
  CONSTRAINT `fk_Grand_Prix_F1_Seasons1`
    FOREIGN KEY (`F1_Seasons_season_id`)
    REFERENCES `cs340_gottlija`.`F1_Seasons` (`season_id`)
    ON DELETE CASCADE
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `cs340_gottlija`.`Grand_Prix_has_Teams`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `cs340_gottlija`.`Grand_Prix_has_Teams` (
  ...
  CONSTRAINT `fk_Grand_Prix_has_Teams_Grand_Prix1`
    FOREIGN KEY (`Grand_Prix_race_id`)
    REFERENCES `cs340_gottlija`.`Grand_Prix` (`race_id`)
    ON DELETE CASCADE
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Grand_Prix_has_Teams_Teams1`
    FOREIGN KEY (`Teams_team_id`)
    REFERENCES `cs340_gottlija`.`Teams` (`team_id`)
    ON DELETE CASCADE
    ON UPDATE NO ACTION)
...
INSERT INTO `F1_Seasons` (`season_id`, `num_races`, `year`) VALUES
(1, 21, 2019),
(2, 17, 2020),
(3, 22, 2021),
(4, 22, 2022),
...
INSERT INTO `Grand_Prix` (`race_id`, `race_name`, `distance_per_lap`, `num_laps`, `has_sprint`, `F1_Seasons_season_id`) VALUES
(1, 'Bahrain Grand_Prix', 5.142, 57, 0, 4),
(2, 'Saudi Arabian Grand_Prix', 6.174, 50, 0, 4),
(3, 'Australian Grand_Prix', 5.412, 58, 0, 4),
(4, 'Bahrain Grand_Prix', 5.412, 57, 0, 5),
(5, 'Azerbaijan Grand_Prix', 6.003, 51, 1, 5);
...
INSERT INTO `Grand_Prix_has_Teams` (`Grand_Prix_race_id`, `Teams_team_id`) VALUES 
(1, 1),
(1, 2),
(1, 3),
(2, 1),
